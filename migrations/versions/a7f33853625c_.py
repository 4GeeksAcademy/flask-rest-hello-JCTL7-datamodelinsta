...
Revision ID: a7f33853625c
Revises: a5cffa318ac2
Create Date: 2026-01-07 18:18:20.576190
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('PHOTO', 'VIDEO', name='typemedia', native_enum=False), nullable=False),
